<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="family.aspx.cs" Inherits="HTyoLippumestari.family" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="cssmenu">
        <ul>
            ...
            <li class="active"><a href="family.aspx"><span>Perhe</span></a></li>
        ...
        <asp:Repeater ID="repEvent" runat="server">
            <ItemTemplate>
                <table style="margin-bottom: 15px; width: 700px;">
                    <tr>
                        <div style="background-color: black; color: white; float: left; width: 500px;">
                            <%# DataBinder.Eval(Container.DataItem, "eventname") %> - <%# DataBinder.Eval(Container.DataItem, "venuename") %> - <%# DataBinder.Eval(Container.DataItem, "date", "{0:dd/MM/yyyy | H:mm}") %><br />
                            <div style="background-color: pink; color: black;"><%# DataBinder.Eval(Container.DataItem, "description") %></div>
                            <div style="float: left;">Ikäraja: <%# DataBinder.Eval(Container.DataItem, "agelimit") %></div>
                            <br />
