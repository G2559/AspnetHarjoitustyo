<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="clubs.aspx.cs" Inherits="HTyoLippumestari.clubs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="cssmenu">
        <ul>
            ...
            <li class="last active"><a href="clubs.aspx"><span>Klubit</span></a></li>
        </ul>
    </div>
